##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.10.0-B14] date: [Sat Jul 03 13:15:18 PDT 2021]
##########################################################################################################################
...
#######################################
# link script
LDSCRIPT = STM32G031K8Ux_FLASH.ld
...
#######################################
# ASM objects first for correct handling of weak symbols with -flto
...
set_optionbytes:
	JLinkExe -Device STM32G031K8 -If SWD -Speed auto -NoGui 1 -CommandFile option_bytes.jlink
